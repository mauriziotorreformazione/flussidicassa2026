...
st.markdown(
    ...
    "Web App creata da <strong>Maurizio Torre</strong></div>",
...
st.markdown(
    ...
    "Web App creata da <strong>Maurizio Torre</strong> · "
    "Piano Annuale dei Flussi di Cassa · Scuole Italiane · 2026"
    "</div>",
    unsafe_allow_html=True
)
